...
void HariMain(void)
{
  ...
  putfont8(binfo->vram, binfo->scrnx, 8, 24, COL8_FFFFFF, hankaku + '1' * 16);
  putfont8(binfo->vram, binfo->scrnx, 16, 24, COL8_FFFFFF, hankaku + '2' * 16);
  putfont8(binfo->vram, binfo->scrnx, 24, 24, COL8_FFFFFF, hankaku + '3' * 16);
